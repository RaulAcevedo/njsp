...
class fw_options_class
{
	...
	function social_network()
	{
		...
		$social_icon = array('facebook' => 'Facebook', 'twitter' => 'Twitter', 'rss'=>'RSS Feeds', 'yahoo' => 'Yahoo', 'flicker'=>'Flickr',
							'stumbleupon'=>'Stumbleupon', 'msn'=>'MSN');
