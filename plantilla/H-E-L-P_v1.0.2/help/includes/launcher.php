	...
	function theme_metabox()
	{
		...
		if($GLOBALS['pagenow'] == 'post-new.php' || $GLOBALS['pagenow'] == 'post.php')
		{
			if( $post_type == 'page' )
			{
				...
				$GLOBALS['_webnukes']->html->js(array('jquery.jqtransform.js', 'jquery.tmpl.min.js', 'layout.js'));
				$GLOBALS['_webnukes']->html->css(array('jqtransform.css','responsive.css','page_builder.css'));
			}
		}
