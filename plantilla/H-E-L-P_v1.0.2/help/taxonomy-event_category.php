...
<div style="background:url(<?php echo kvalue( $settings,'event_banner_image');?>);" class="banner">
    <div class="container">
        <h1><?php echo kvalue($settings, 'event_banner_heading'); ?></h1>
...
<div class="container">
    <div class="row">
        ...
        <div class="span3"><?php dynamic_sidebar( kvalue( $settings, 'event_sidebar') ); ?></div>
	</div>
</div>
